...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get settingsFitMainListWidth => 'Fit main list to screen width';

  @override
  String get settingsMainListColumns => 'Main list columns:';

  @override
  String get settingsMainListColumnsAuto => 'Auto';
  ...
  String addMinusOneCard(String direction, int count) {
    String _temp0 = intl.Intl.selectLogic(direction, {
      'added': 'Add -1 card (added: $count)',
      'removed': 'Add -1 card (removed: $count)',
      'other': 'Add -1 card ($count)',
    });
    return '$_temp0';
  }
  ...
  @override
  String get characterNoteHint => 'Add a note…';

  @override
  String get characterNoteQuickAdd => 'Quick note';
