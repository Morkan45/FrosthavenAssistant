...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get settingsFitMainListWidth =>
      'Ajustar la lista principal al ancho de pantalla';

  @override
  String get settingsMainListColumns => 'Columnas de la lista principal:';

  @override
  String get settingsMainListColumnsAuto => 'Automático';
  ...
  @override
  String get characterNamePlaceholder => 'Nombre';
  ...
  String addMinusOneCard(String direction, int count) {
    String _temp0 = intl.Intl.selectLogic(direction, {
      'added': 'Añadir carta -1 (añadidas: $count)',
      'removed': 'Añadir carta -1 (quitadas: $count)',
      'other': 'Carta -1 ($count)',
    });
    return '$_temp0';
  }
